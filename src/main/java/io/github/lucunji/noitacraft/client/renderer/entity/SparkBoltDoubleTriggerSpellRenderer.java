...
public class SparkBoltDoubleTriggerSpellRenderer extends EntityRenderer<SparkBoltSpellEntity> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(NoitaCraft.MOD_ID, "textures/entity/spell/spark_bolt_trigger_double.png");

    public SparkBoltDoubleTriggerSpellRenderer(EntityRendererManager renderManager) {
        super(renderManager);
    }
