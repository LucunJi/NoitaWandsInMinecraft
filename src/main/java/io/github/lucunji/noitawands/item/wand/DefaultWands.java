...
public class DefaultWands {
    public static final ItemStack HANDGUN = makeWandStack(4, false, 30, (byte)1,
            0f, 8, (byte)3, 1, 100,
            ModItems.SPELL_SPARK_BOLT, ModItems.SPELL_SPARK_BOLT).setDisplayName(new TranslationTextComponent("item.noitaWands.wand.starting"));

    public static final ItemStack BOMB_WAND = makeWandStack(2, false, 10, (byte)1,
            0f, 1, (byte)1, 2, 100,
            ModItems.SPELL_BOMB).setDisplayName(new TranslationTextComponent("item.noitaWands.wand.starting"));
    ...
    public static ItemStack makeWandStack(int castDelay, boolean shuffle, int manaChargeSpeed, byte casts,
        ...
        ItemStack itemStack = new ItemStack(ModItems.WAND, 1);
