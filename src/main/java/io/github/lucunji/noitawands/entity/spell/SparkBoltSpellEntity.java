...
public class SparkBoltSpellEntity extends SpellEntityMagicalBase {
    ...
    public SparkBoltSpellEntity(EntityType<? extends SparkBoltSpellEntity> type, World worldIn) {
        super(type, worldIn);
        this.inGround = false;
    }

    public SparkBoltSpellEntity(EntityType<? extends SparkBoltSpellEntity> type, LivingEntity caster, World world) {
        this(type, world);
